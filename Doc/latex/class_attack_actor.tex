...
Attack\+Actor.\+cs 파일의 33 번째 라인에서 정의되었습니다.


\begin{DoxyCode}
34     \{
35         \textcolor{keywordflow}{return} \textcolor{keyword}{new} \textcolor{keywordtype}{string}[] \{ \textcolor{stringliteral}{"range"}, \textcolor{stringliteral}{"damage"} \};
36     \}
\end{DoxyCode}
...
\begin{DoxyCode}
227     \{
228         \textcolor{keywordflow}{if} (\hyperlink{class_attack_actor_ae8b11071e5df53e1bda6649bd9075571}{\_stateMachine} != null)
229         \{
230             \hyperlink{class_attack_actor_ae8b11071e5df53e1bda6649bd9075571}{\_stateMachine}.ChangeState(type.ToString());
231         \}
232     \}
\end{DoxyCode}
...
Attack\+Actor.\+cs 파일의 203 번째 라인에서 정의되었습니다.
...
Attack\+Actor.\+cs 파일의 214 번째 라인에서 정의되었습니다.


\begin{DoxyCode}
215     \{
216         var state = \hyperlink{class_attack_actor_ac231e370a4747dc36886f4158b289898}{GetCurrentState}();
217 
218         \textcolor{keywordflow}{if} (state != null)
219         \{
220             \textcolor{keywordflow}{return} state.GetCurrentType();
221         \}
222 
...
\begin{center}
\leavevmode
\includegraphics[width=324pt]{class_f_z_1_1_actor_ac29de02b4c3cc1012143f6531f5809ed_icgraph}
\end{center}
\end{figure}
...
Attack\+Actor.\+cs 파일의 187 번째 라인에서 정의되었습니다.
...
189         base.Initialize();
190 
191         \hyperlink{class_attack_actor_a4c1408e09de62ad12b42bee3251556ba}{StorageStates}();
192 
193         \hyperlink{class_attack_actor_a97035efd9d67dd78cfa55cf321426567}{ChangeState}(\hyperlink{_attack_actor_8cs_a10659ce944335df4ded984f6bc41f31b}{eAttackActType}.NORMAL);
194     \}
\end{DoxyCode}
...
Attack\+Actor.\+cs 파일의 248 번째 라인에서 정의되었습니다.


\begin{DoxyCode}
249     \{
250         base.Interactive(interactTarget);
251 
252         var tile = interactTarget as \hyperlink{class_tile}{Tile};
253 
254         \textcolor{keywordflow}{if} (tile != null)
255         \{
256             var state = \hyperlink{class_attack_actor_ac231e370a4747dc36886f4158b289898}{GetCurrentState}();
257 
258             \textcolor{keywordflow}{if} (state != null)
259             \{
260                 state.Interactive(tile);
261 
262                 \textcolor{keywordflow}{return};
263             \}
264         \}
265 
266         \textcolor{keywordflow}{throw} \textcolor{keyword}{new} UnityException(\textcolor{stringliteral}{"don't have attackAct state."});
267     \}
\end{DoxyCode}
...
Attack\+Actor.\+cs 파일의 234 번째 라인에서 정의되었습니다.


\begin{DoxyCode}
235     \{
236         base.OnTouchEvent(touch);
237 
238         var state = \hyperlink{class_attack_actor_ac231e370a4747dc36886f4158b289898}{GetCurrentState}();
239 
240         \textcolor{keywordflow}{if} (state != null)
241         \{
242             \textcolor{keywordflow}{return} state.OnTouchEvent();
243         \}
244 
245         \textcolor{keywordflow}{throw} \textcolor{keyword}{new} UnityException(\textcolor{stringliteral}{"don't have attackAct state."});
246     \}
\end{DoxyCode}
...
Attack\+Actor.\+cs 파일의 196 번째 라인에서 정의되었습니다.
...
\subsubsection[{\texorpdfstring{\+\_\+state\+Machine}{_stateMachine}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf F\+Z.\+State\+Machine}$<${\bf Attack\+Act\+State}$>$ Attack\+Actor.\+\_\+state\+Machine = new {\bf F\+Z.\+State\+Machine}$<${\bf Attack\+Act\+State}$>$()\hspace{0.3cm}{\ttfamily [private]}}\hypertarget{class_attack_actor_ae8b11071e5df53e1bda6649bd9075571}{}\label{class_attack_actor_ae8b11071e5df53e1bda6649bd9075571}
...
\subsubsection[{\texorpdfstring{Act\+Target}{ActTarget}}]{\setlength{\rightskip}{0pt plus 5cm}new {\bf Unit\+Object} F\+Z.\+Unit\+Obj\+Actor.\+Act\+Target\hspace{0.3cm}{\ttfamily [get]}, {\ttfamily [protected]}, {\ttfamily [inherited]}}\hypertarget{class_f_z_1_1_unit_obj_actor_a9343320a7b31731b88fa6ab91d649328}{}\label{class_f_z_1_1_unit_obj_actor_a9343320a7b31731b88fa6ab91d649328}
