...
50             \{
51                 datas = JsonUtility.FromJson<T>(factory.\hyperlink{class_data_factory_a5f040ba1715a670e29f45e07d22b4d5b}{GetJsonString}());
52             \}
53             \textcolor{keywordflow}{catch} (Exception e)
54             \{
55                 \textcolor{keywordflow}{throw} \textcolor{keyword}{new} UnityException(typeof(T) + \textcolor{stringliteral}{" : "} + e.ToString());
56             \}
57 
58             \textcolor{keywordflow}{return} datas;
59         \}
\end{DoxyCode}
